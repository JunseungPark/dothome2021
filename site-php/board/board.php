                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            // 1~20 : DESC LIMIT 0, 20;  --> $page1 ($nunView * $page) - numView;
                                            // 21~40 : DESC LIMIT 20, 20;  --> $page2 ($nunView * $page) - numView;
                                            // 41~60 : DESC LIMIT 40, 20;  --> $page3 ($nunView * $page) - numView;
                                            // 61~80 : DESC LIMIT 60, 20;  --> $page4 ($nunView * $page) - numView;
                                            // 81~100 : DESC LIMIT 80, 20;  --> $page5 ($nunView * $page) - numView;

                                            //board + member
                                            $sql = "SELECT b.myBoardID, b.boardTitle, m.youName, b.boardView, b.regTime FROM myMember m JOIN myBoard b ON (m.myMemberID = b.myMemberID) ORDER BY b.myBoardID DESC LIMIT {$viewLimit}, {$numView}";
                            ...
                            <div class="board-page">
                                <ul>
                                    <?php
                                        ...
                                        // 처음으로 
                                        if($page != 1) echo "<li><a href='board.php?page=1'>처음으로</a></li>";
                                        ...
                                        // 마지막으로 
                                        if($page != $endPage) echo "<li><a href='board.php?page={$boardTotalPage}'>마지막으로</a></li>";
                                    ?>
                                    <!-- <li><a href="#">처음으로</a></li>
                                    <li><a href="#">처음</a></li>
