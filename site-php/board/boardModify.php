                    ...
                    <div class="boardType">
                        ...
                        <section class="boardModify">
                            <form action="boardModifySave.php" name="boardModify" method="post">
                                <fieldset>
                                    <legend class="ir_so">게시만 수정 영역입니다.</legend>
                                    <?php
                                        ...
                                        if($result) {
                                            ...
                                            echo "<textarea type='text' name='boardContent' id='boardContent' row='13'>".$info['boardContent']."</textarea></div>";
                                            echo "<div><label for='boardPass'>비밀번호</label>";
                                            echo "<input type='password' name='boardPass' id='boardPass' placeholder='로그인 비밀번호를 입력해주세요'></div>";
                                        }
                                    ?>
                                </fieldset>
