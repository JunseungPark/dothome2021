                    ...
                    <form name="join" action="joinSave.php" method="POST">
                        <fieldset>
                            ...
                            <div class="member-box">
                                ...
                                <div>
                                    <lable for="youPass">비밀번호</lable>
                                    <input type="password" name="youPass" id="youPass" class="input_write" placeholder="비밀번호를 적어주세요" autocomplete="off" required>
                                </div>
                                <div>
                                    <lable for="youPassC">비밀번호 확인</lable>
                                    <input type="password" name="youPassC" id="youPassC" class="input_write" placeholder="비밀번호를 다시 적어주세요" autocomplete="off" required> 
                                </div>
                                <div>
                                    <lable for="youName">이름</lable>
                                    <input type="text" name="youName" id="youName" class="input_write" maxlength="5" placeholder="이름을 적어주세요" autocomplete="off" required>
                                </div>
                                <div>
                                    <lable for="youBirth">생년월일</lable>
                                    <input type="text" name="youBirth" id="youBirth" class="input_write" placeholder="YYYY-MM-DD" autocomplete="off" required>
                                </div>
                                <div>
                                    <lable for="youPhone">휴대폰 번호</lable>
